...
public class DAOQuery {
	...
	public static final String SQL_UPDATE_PRODUCT_IN_CART = "UPDATE `qbryx`.`cart` SET `is_purchased` = 1 WHERE `user_id` = ? AND `product_id` = ?;";
	...
	public static final String HQL_UPDATE_PRODUCT_IN_CART = "update CartProduct set is_purchased = 1 where userId = :userId and product_id = :product_id";
